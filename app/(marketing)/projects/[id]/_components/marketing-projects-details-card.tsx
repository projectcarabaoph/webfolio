        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-row flex-wrap gap-4">
              {project.demo_url && (
                <Link href={project.demo_url} className="flex flex-row gap-2 text-neutral-200 hover:text-neutral-300 bg-custom-purple-950  border border-custom-purple-800 py-1 px-2 rounded-md">
              ...
              {project.repo_url?.[0] && (
                <Link href={project.repo_url?.[0]} className="flex flex-row gap-2 text-neutral-200 hover:text-neutral-300 bg-custom-purple-950  border border-custom-purple-800 py-1 px-2 rounded-md">
              ...
              {project.repo_url?.[1] && (
                <Link href={project.repo_url?.[1]} className="flex flex-row gap-2 text-neutral-200 hover:text-neutral-300 bg-custom-purple-950  border border-custom-purple-800 py-1 px-2 rounded-md">
                  <Icon icon="mdi:github"
                    width="24"
                    height="24"
                  />
